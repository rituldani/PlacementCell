    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="https://jecrcuniversity.edu.in/">JECRC University</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p>JECRC University, <br>
                    Ramchandrapura Industrial Area,
                    Vidhani, Sitapura Extension, Jaipur-303905.
					1800-120-5616</p>
					<a href="mailto:admission@jecrcu.edu.in">admission@jecrcu.edu.in</a>
				</div>
