...
<title>GradMatch | Contact Us</title>
		...
		<div class="container">
			...
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<p>Ramchandrapura Industrial Area,
						<span>Vidhani, Sitapura Extension, Jaipur-303905.</span>
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: 1800-120-5616 </p>
					E-mail: <a href="mailto:admission@jecrcu.edu.in">admission@jecrcu.edu.in</a>
				</div>
