				...
				<div class="top-nav">
						...
						<ul class="nav1">
							...
							<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">GradMatch<i>Goto Placement Homepage</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
								<a href="index.php">Home<i>Get the Overview of the Site</i></a>
								</li>
								<li class="hvr-sweep-to-bottom">
									<a href="about.php">About<i>About our TPO'S </i></a>
								</li>
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Our institute is located in Jaipur, a renowned hub of education. JECRC University is recognized by the University Grants Commission (UGC) and is approved by the All India Council for Technical Education (AICTE), New Delhi. Over the years, we have made a significant impact in the competitive education sector, achieving several milestones. Our ISO Certification and NBA Accreditation reflect our dedication to providing quality education and maintaining high standards. Our academic excellence is recognized by industries, engineering institutions, professional bodies, and government organizations. Recently, JECRC University has been rated with an 'A' grade and is featured among 'THE BEST ENGINEERING UNIVERSITIES IN INDIA' by Career360, a well-respected magazine published by the OUTLOOK Group.
						</p>
					</div>
				</div>
				<div class="clearfix"> </div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="address">
						<p>JECRC University,
						<spam>Ramchandrapura Industrial Area,</spam>
						<spam>Vidhani, Sitapura Extension, Jaipur-303905.</spam>
						</p>
					</div>
					<div class="phone">
						<p>1800-120-5616</p>
